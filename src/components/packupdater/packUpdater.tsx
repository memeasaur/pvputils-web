        ...
        <div className={"flex gap-4"}>
            <form className={"flex flex-col gap-4"}>
                <label className={"flex gap-2"}>
                    <input defaultChecked type={"checkbox"}/>pack name watermark
                </label>
                <div className={"flex gap-2"}>
                    ...
                    <input defaultValue={" (1.21.4)"} type={"text"}/>
                </div>

                <label className={"flex gap-2"}>
                    <input defaultChecked type={"checkbox"}/>pack description watermark
                </label>
                <div className={"flex gap-2"}>
                    ...
                    <input defaultValue={" (generated by TODO, v" + VERSION + ")"} type={"text"}/>
                </div>
