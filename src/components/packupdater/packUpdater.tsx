            ...
            <form className={"flex flex-col gap-4"}>
                <div className={"flex gap-2"}>
                    <label className={"flex gap-2"}>
                        ...
                        {/*TODO -> onChange hide text inputs*/}
                    </label>
                    <input placeholder={" (1.21.4)"} type={"text"} onClick={e => {
                ...
                <div className={"flex flex-col gap-2"}>
                    ...
                    <input placeholder={" (generated by pvputils.vercel.app, v" + VERSION + ")"} type={"text"} onClick={e => {
                        const target = e.currentTarget
                        if (!target.value)
                ...
                <label className={"flex gap-2"}>
                    <input type={"text"} placeholder={"ninja (minecraft igns only)"}></input>
                </label>
